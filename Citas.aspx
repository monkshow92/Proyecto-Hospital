<%@ Page Title="Citas" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="Citas.aspx.cs" Inherits="Citas" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" Runat="Server">
    <p>
        <img alt="Banner Cita Medica" src="images/citaMedica.jpg" class="margen" /></p>
        <p>
            <span class="auto-style1">Datos de la Cita Medica</span></p>
            &nbsp;<br />
        <p>
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        ...
        <p>
            ...
            <asp:SqlDataSource ID="SqlDataSource3" runat="server" ConnectionString="<%$ ConnectionStrings:ConexionHospital %>" SelectCommand="SELECT P.nombres + ' ' +P.apellidos as Paciente, D.nombres + ' ' +D.apellidos as Doctor, [Fecha_Hora], [Motivo] FROM [Cita] C inner join Cuenta Cu
on Cu.numCuenta = C.nroCuenta
inner join Paciente P 
on P.idPaciente = Cu.idPaciente
inner join Doctor D 
on D.idDoctor = C.idDoctor"></asp:SqlDataSource>
...
<asp:Content ID="Content3" runat="server" contentplaceholderid="Menu">
    <ul>
        ...
        <li class="m4"><a href="Citas.aspx"  class="active"><span><b>Citas</b></span></a></li>
